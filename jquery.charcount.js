...
(function($) {
	...
	var isChromeOrMozilla = $.browser.hasOwnProperty("chrome") || $.browser.hasOwnProperty("mozilla");
	...
	$.fn.charcount = function(options) {
		...
		if (isChromeOrMozilla && this.is("textarea")) {

			$.data(this[0], "W", this.outerWidth());
			$.data(this[0], "H", this.outerHeight());

			this.bind("mouseup.charcount", function() {
